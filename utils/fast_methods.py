# Copied from flatland-rl==4.0.3 in flatland.envs.fast_methods for compatibility with flatland-rl==3.X.X
...
@lru_cache()
def fast_argmax(possible_transitions) -> int:
...
@lru_cache()
def fast_count_nonzero(possible_transitions):
