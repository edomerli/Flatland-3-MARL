...
def create_train_env(env_size):
    ...
    env_args = {
        ...
        # TODO: NOTA (to remove), una differenza con il codice di fasttreeobs è che lui gli passa una sparse schedule
        # mentre qui non la passo -> di default mette una random schedule. Nel metadata che ho preso non c'è
        # quindi direi che anche nel test set non la usano
